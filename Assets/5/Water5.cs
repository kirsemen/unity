...
public class Water5 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Physics.Raycast(transform.position, -transform.up, out hit))
        {
            ...
            UnityEngine.Vector2 pos = hit.textureCoord * new UnityEngine.Vector2(texture.width, texture.height) - new UnityEngine.Vector2(1, 1);
            computeShader2.SetInts("pos", new int[] { (int)pos.x, (int)pos.y });
            computeShader2.SetInts("sizePoint", new int[] { 2, 2 });
